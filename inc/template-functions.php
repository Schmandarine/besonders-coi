 ...
 * @return array
 */
function besonders_coi_body_classes( $classes ) {
...
add_filter( 'body_class', 'besonders_coi_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function besonders_coi_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">', esc_url( get_bloginfo( 'pingback_url' ) ) );
	}
}
add_action( 'wp_head', 'besonders_coi_pingback_header' );
