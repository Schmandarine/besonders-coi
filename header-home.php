...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-navigation-fixed">
				...
				<div class="site-navigation-container">
					<div class="site-branding">
						<a href="<?php echo get_home_url(); ?>">
							<img width="250" height="40" src="<?php echo get_template_directory_uri(); ?>/img/logo-horizontal.svg" alt="COI Dokumentenmanagement Software">
						</a>
					</div><!-- .site-branding -->
			...
			<div class="svg-slant">
				<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" class="slant-shadow" viewBox="0 0 1920 120">
		...
		<div class="hero-wrapper hero-bg-img">
			...
			<div class="hero-content site-navigation-container">
				<h1 class="m-0"><?php the_field('site_title'); ?></h1>
		<?php
		
			echo '<a target="_blank" title="Förderung sichern" href="https://www.coi.de/module/foerderung"><img width="330" height="380" alt="Förderung sichern" src="'.get_template_directory_uri().'/img/hexagon-foerderung-sichern.svg" class="hexagon-digital-bmwi"></a>';
			
		?>
			</div>
			<a title="arrow down" href="#primary" class="hero-arrow-down">
